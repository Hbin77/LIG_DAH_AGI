...
aura_attack_decision_path_audit no_op_threshold_violations: 0
...
operator_alerts rows: 52 actions=5
defense_effectiveness_ledger rows: 52 actions=5
...
package_hash: outputs/package/release_handoff.md에서 확인
