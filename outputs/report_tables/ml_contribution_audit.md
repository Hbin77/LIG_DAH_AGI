...
| M05 | Closed-loop ML separation | pass | g10_status=pass; abs_e7_minus_e6=0.0141698; e6_mission_impact_mean=0.14545049447138922; e7_mission_impact_mean=0.1596203171086737 | The ML defender path changes closed-loop behavior relative to rule TSRA-R, so E7 is not a duplicate experiment row. |
| M06 | E7 ML closed-loop actions | pass | attack_events=5; attack_types=failover_chasing,queue_pressure; defense_events=34; ml_attack_alert_count=9; defense_actions=ml_attack_alert,pace_switch,priority_reroute,stale_badge,video_throttle | The ML-vs-ML episode contains actual ML-ranked attack choices and ML anomaly alerts. |
...
- Observed: g10_status=pass; abs_e7_minus_e6=0.0141698; e6_mission_impact_mean=0.14545049447138922; e7_mission_impact_mean=0.1596203171086737
- Status: pass
...
- Observed: attack_events=5; attack_types=failover_chasing,queue_pressure; defense_events=34; ml_attack_alert_count=9; defense_actions=ml_attack_alert,pace_switch,priority_reroute,stale_badge,video_throttle
- Status: pass
