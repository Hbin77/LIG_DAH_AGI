...
| M03 | AURA-ML tool invocation | pass | experiments=E6_ml_aura_tsra_r,E7_ml_aura_ml_tsra_r; predict_candidate_impact_invocations=52; errors=0 | The ML impact model is part of the AURA-ML agent loop, not only an offline metric file. |
...
| M05 | Closed-loop ML separation | pass | g10_status=pass; abs_e7_minus_e6=0.0167761; e6_mission_impact_mean=0.14924049493637673; e7_mission_impact_mean=0.16601660714138822 | The ML defender path changes closed-loop behavior relative to rule TSRA-R, so E7 is not a duplicate experiment row. |
| M06 | E7 ML closed-loop actions | pass | attack_events=5; attack_types=failover_chasing,queue_pressure; defense_events=33; ml_attack_alert_count=9; defense_actions=ml_attack_alert,pace_switch,priority_reroute,stale_badge,video_throttle | The ML-vs-ML episode contains actual ML-ranked attack choices and ML anomaly alerts. |
...
- Observed: experiments=E6_ml_aura_tsra_r,E7_ml_aura_ml_tsra_r; predict_candidate_impact_invocations=52; errors=0
- Status: pass
...
- Observed: g10_status=pass; abs_e7_minus_e6=0.0167761; e6_mission_impact_mean=0.14924049493637673; e7_mission_impact_mean=0.16601660714138822
- Status: pass
...
- Observed: attack_events=5; attack_types=failover_chasing,queue_pressure; defense_events=33; ml_attack_alert_count=9; defense_actions=ml_attack_alert,pace_switch,priority_reroute,stale_badge,video_throttle
- Status: pass
