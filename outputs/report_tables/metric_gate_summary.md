...
| G10 | ML defender separation | abs(E7 mission_impact_mean - E6 mission_impact_mean) | 0.0141698 | >= 0.005 | pass | E7 should remain behaviorally distinct from E6 so ML TSRA-R is not a no-op copy. |
