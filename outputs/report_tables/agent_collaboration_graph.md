...
| E04 | TSRA-R/TSRA-R-ML | MissionSimulator | 52 | verified | outputs/report_tables/operator_alerts.csv | Connects defense decisions to simulator-visible response actions. |
| E05 | MissionSimulator | Mission Metrics | 47 | verified | outputs/report_tables/battle_timeline.csv | Keeps the red/blue loop tied to measurable mission effects. |
...
| E10 | DefenseEvent | Operator Alerts | 52 | verified | outputs/report_tables/operator_alerts.csv | Turns TSRA-R output into human-readable response guidance. |
...
| E13 | DefenseEvent | Defense Effectiveness Ledger | 52 | verified | outputs/report_tables/defense_effectiveness_ledger.csv | Turns defensive actions into event-level effectiveness evidence. |
...
| E15 | AgentTool | Verifier/Package | 33 | verified | outputs/report_tables/agent_tool_usage_audit.csv | Proves tools are invoked inside agent decision loops. |
