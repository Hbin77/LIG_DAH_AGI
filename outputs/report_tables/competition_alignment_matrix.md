...
- Status: verified
- Notes: outputs/batch/tsra_action_ablation_summary.csv rows=5; outputs/report_tables/pace_transition_audit.csv rows=4; outputs/report_tables/operator_alerts.csv rows=53; outputs/report_tables/defense_effectiveness_ledger.csv rows=53; outputs/report_tables/defense_action_attribution_audit.csv rows=5
...
- Status: verified
- Notes: outputs/report_tables/battle_timeline.csv rows=48; outputs/report_tables/incident_summary.csv rows=10; outputs/report_tables/closed_loop_episode_replay.csv rows=10; outputs/report_tables/mission_thread_summary.csv rows=10; outputs/report_tables/agent_engagement_scorecard.csv rows=10; outputs/report_tables/defense_effectiveness_ledger.csv rows=53; outputs/report_tables/defense_action_attribution_audit.csv rows=5; outputs/report_tables/agent_collaboration_graph.csv rows=17; outputs/report_tables/agent_coordination_latency_audit.csv rows=10; outputs/report_tables/agent_stress_scenario_audit.csv rows=6; outputs/report_tables/ml_red_blue_interaction_audit.csv rows=5; outputs/report_tables/attack_defense_coverage.csv rows=4; outputs/report_tables/attack_defense_response_audit.csv rows=10
