...
- Trace: `aura-trace-00001` from `aura_decision_traces.jsonl` at t=0 sec
...
- Policy: `rule_attack_score`
- Trace: `aura-trace-00007` from `aura_decision_traces.jsonl` at t=60 sec
...
- Trace: `tsra-r-trace-00001` from `tsra_r_decision_traces.jsonl` at t=0 sec
- Observe: phase=normal_patrol; active_link=SATCOM; critical_pending=0; queue_kb=32.024; video_kb=0; stale=0; priority_inversion=0
...
- Policy: `rule_defense_full`
- Trace: `tsra-r-trace-00005` from `tsra_r_decision_traces.jsonl` at t=20 sec
...
- Trace: `aura-ml-trace-00001` from `aura_decision_traces.jsonl` at t=0 sec
- Observe: phase=normal_patrol; active_link=SATCOM; critical_pending=0; queue_kb=32.024; video_kb=0; stale=0; priority_inversion=0
- Memory: observations=1; decisions=0; last_selected=
- Tools: summarize_defense_context -> active_defense_actions=; active_defense_count=0; counter_defense_context_seen=False
- Candidates: none
...
- Policy: `ml_impact_predictor`
- Trace: `aura-ml-trace-00007` from `aura_decision_traces.jsonl` at t=60 sec
- Observe: phase=normal_patrol; active_link=SATCOM; critical_pending=0; queue_kb=32.155; video_kb=0; stale=0.5; priority_inversion=0.1935
- Memory: observations=7; decisions=6; last_selected=no_op; event_count=1; last_attack_type=queue_pressure
...
## Replay-07: E7_ml_aura_ml_tsra_r / TSRA-R / no_op

- Policy: `rule_defense_full`
- Trace: `tsra-r-trace-00002` from `tsra_r_rule_delegate_traces.jsonl` at t=75 sec
- Observe: phase=normal_patrol; active_link=LTE; critical_pending=0; queue_kb=6004.65; video_kb=5973.06; stale=0.5; priority_inversion=0.2159
- Memory: observations=2; decisions=1; last_selected=defense_events; mode=full; event_count=4; enabled_actions=pace_switch,priority_reroute,stale_badge,video_throttle
- Tools: evaluate_defense_conditions -> priority_reroute_needed=False; stale_badge_needed=True; pace_switch_needed=False; video_throttle_needed=True; summarize_attack_context -> active_attack_count=1; active_attack_targets=SATCOM; active_attack_types=queue_pressure
- Candidates: video_throttle; score=0.225; impact=; detectability=; target= || stale_badge; score=0.195; impact=; detectability=; target= || priority_reroute; score=0; impact=; detectability=; target=; total=4
- Selected action: no_op
- Feedback: event_count=4; mode=full; enabled_actions=pace_switch,priority_reroute,stale_badge,video_throttle
- Reason: no defense action emitted
- Safety boundary: closed simulation agent-loop replay only; no RF, exploit, or live network action

## Replay-08: E7_ml_aura_ml_tsra_r / TSRA-R / action

- Policy: `rule_defense_full`
- Trace: `tsra-r-trace-00001` from `tsra_r_rule_delegate_traces.jsonl` at t=70 sec
...
- Memory: observations=1; decisions=0; last_selected=; mode=full; event_count=4; enabled_actions=pace_switch,priority_reroute,stale_badge,video_throttle
- Tools: evaluate_defense_conditions -> priority_reroute_needed=True; stale_badge_needed=True; pace_switch_needed=True; video_throttle_needed=True; summarize_attack_context -> active_attack_count=1; active_attack_targets=SATCOM; active_attack_types=queue_pressure; select_fallback_link -> LTE
- Candidates: priority_reroute; score=0.94; impact=; detectability=; target= || stale_badge; score=0.78; impact=; detectability=; target= || pace_switch; score=0.72; impact=; detectability=; target=; total=4
...
- Feedback: event_count=4; mode=full; enabled_actions=pace_switch,priority_reroute,stale_badge,video_throttle
- Reason: emitted 4 defense event(s)
- Safety boundary: closed simulation agent-loop replay only; no RF, exploit, or live network action

## Replay-09: E7_ml_aura_ml_tsra_r / TSRA-R-ML / no_op

- Policy: `ml_anomaly_detector`
- Trace: `tsra-r-ml-trace-00001` from `tsra_r_decision_traces.jsonl` at t=0 sec
- Observe: phase=normal_patrol; active_link=SATCOM; critical_pending=0; queue_kb=32.024; video_kb=0; stale=0; priority_inversion=0
...
## Replay-10: E7_ml_aura_ml_tsra_r / TSRA-R-ML / action

- Policy: `ml_anomaly_detector`
- Trace: `tsra-r-ml-trace-00015` from `tsra_r_decision_traces.jsonl` at t=70 sec
- Observe: phase=normal_patrol; active_link=SATCOM; critical_pending=1; queue_kb=5421.4; video_kb=5239.34; stale=0.5; priority_inversion=0.2568
