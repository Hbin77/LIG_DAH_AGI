...
| MAP04 | Detectability-adjusted score | pass | candidate_total=26; score_formula_matches=26; selection_score_formula_matches=26; objective_bonus_candidates=1; selected_objective_bonus_count=1; selected_detectability_min=0.15; selected_detectability_max=0.55 | AURA-ML keeps the detectability-adjusted base score explicit, then applies a bounded objective adjustment so tactical coverage is visible rather than hidden. |
...
- Observed: candidate_total=26; score_formula_matches=26; selection_score_formula_matches=26; objective_bonus_candidates=1; selected_objective_bonus_count=1; selected_detectability_min=0.15; selected_detectability_max=0.55
- Status: pass
- Interpretation: AURA-ML keeps the detectability-adjusted base score explicit, then applies a bounded objective adjustment so tactical coverage is visible rather than hidden.
- Safety boundary: closed simulation ML attack decision-path audit only; no RF, exploit, or live network action
