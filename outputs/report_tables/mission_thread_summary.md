...
| thread-09 | E7_ml_aura_ml_tsra_r | ml-atk-00004 | failover_chasing | status=complete; first_required_latency_sec=0; covered_required=ml_attack_alert; defense_event_count=7; actions=ml_attack_alert, pace_switch, priority_reroute, stale_badge, video_throttle | start=0.141337; peak=0.144298; end=0.12364; reduction_from_peak=0.0206573; outcome=held near attack-time impact | pass |
| thread-10 | E7_ml_aura_ml_tsra_r | ml-atk-00005 | failover_chasing | status=complete; first_required_latency_sec=0; covered_required=ml_attack_alert; defense_event_count=5; actions=ml_attack_alert, priority_reroute, stale_badge, video_throttle | start=0.122826; peak=0.191303; end=0.154587; reduction_from_peak=0.0367162; outcome=covered with residual mission impact | pass |
...
- Attribution: pace_switch:class=bounded_tradeoff_supported,status=pass,primary=mission_impact,delta=-0.0418751 || priority_reroute:class=ablation_supported,status=pass,primary=priority_inversion_rate,delta=-0.0296057 || stale_badge:class=ablation_supported,status=pass,primary=trusted_stale_exposure,delta=-0.00390625 || video_throttle:class=local_metric_supported,status=pass,primary=p95_critical_latency_sec,delta=-0.560714
...
- Attribution: priority_reroute:class=ablation_supported,status=pass,primary=priority_inversion_rate,delta=-0.0296057 || video_throttle:class=local_metric_supported,status=pass,primary=p95_critical_latency_sec,delta=-0.560714
...
- Attribution: ml_attack_alert:class=reactive_window_supported,status=pass,primary=mission_impact,delta=-0.0195514 || pace_switch:class=bounded_tradeoff_supported,status=pass,primary=mission_impact,delta=-0.0418751 || priority_reroute:class=ablation_supported,status=pass,primary=priority_inversion_rate,delta=-0.0296057 || stale_badge:class=ablation_supported,status=pass,primary=trusted_stale_exposure,delta=-0.00390625 || video_throttle:class=local_metric_supported,status=pass,primary=p95_critical_latency_sec,delta=-0.560714
...
- Attribution: ml_attack_alert:class=reactive_window_supported,status=pass,primary=mission_impact,delta=-0.0195514 || priority_reroute:class=ablation_supported,status=pass,primary=priority_inversion_rate,delta=-0.0296057 || stale_badge:class=ablation_supported,status=pass,primary=trusted_stale_exposure,delta=-0.00390625 || video_throttle:class=local_metric_supported,status=pass,primary=p95_critical_latency_sec,delta=-0.560714
...
- Attribution: ml_attack_alert:class=reactive_window_supported,status=pass,primary=mission_impact,delta=-0.0195514 || pace_switch:class=bounded_tradeoff_supported,status=pass,primary=mission_impact,delta=-0.0418751 || priority_reroute:class=ablation_supported,status=pass,primary=priority_inversion_rate,delta=-0.0296057 || stale_badge:class=ablation_supported,status=pass,primary=trusted_stale_exposure,delta=-0.00390625 || video_throttle:class=local_metric_supported,status=pass,primary=p95_critical_latency_sec,delta=-0.560714
- Metrics: start=0.141337; peak=0.144298; end=0.12364; reduction_from_peak=0.0206573; outcome=held near attack-time impact
...
- Attack decision: agent=AURA; score=0.708246; expected_impact=0.783246; selection_margin=0.059656; threshold_margin=0.588246
- Response: status=complete; first_required_latency_sec=0; covered_required=ml_attack_alert; defense_event_count=5; actions=ml_attack_alert, priority_reroute, stale_badge, video_throttle
- Attribution: ml_attack_alert:class=reactive_window_supported,status=pass,primary=mission_impact,delta=-0.0195514 || priority_reroute:class=ablation_supported,status=pass,primary=priority_inversion_rate,delta=-0.0296057 || stale_badge:class=ablation_supported,status=pass,primary=trusted_stale_exposure,delta=-0.00390625 || video_throttle:class=local_metric_supported,status=pass,primary=p95_critical_latency_sec,delta=-0.560714
- Metrics: start=0.122826; peak=0.191303; end=0.154587; reduction_from_peak=0.0367162; outcome=covered with residual mission impact
- Operator alert count: 5
- Residual risk: Failover chasing is detected by the ML defense window; PACE support may already be active or may expire before a later attack window.
- Status: pass
- Interpretation: Attack, defense response, operator alerts, action attribution, and metric movement form one complete mission thread; defense_events=5, operator_alerts=5, outcome=covered with residual mission impact.
