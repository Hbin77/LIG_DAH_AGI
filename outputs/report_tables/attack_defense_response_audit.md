...
| E7_ml_aura_ml_tsra_r | ml-atk-00004 | failover_chasing | required_covered_support_partial | 0 | none | pace_switch |
| E7_ml_aura_ml_tsra_r | ml-atk-00005 | queue_pressure | complete | 0 | none | none |
...
- Response defenses after attack: ml_attack_alert@180-until-250; stale_badge@180-until-270; priority_reroute@185-until-255; video_throttle@185-until-245
- Covered required defenses: priority_reroute, stale_badge
- Missing required defenses: none
- Missing support defenses: none
- First required response latency sec: 0
...
- Required runtime defenses: ml_attack_alert
- Support defenses: pace_switch, priority_reroute
- Active defenses at attack: stale_badge@120-until-210; video_throttle@150-until-210; stale_badge@150-until-240; ml_attack_alert@155-until-225; priority_reroute@160-until-230; ml_attack_alert@180-until-250; stale_badge@180-until-270; priority_reroute@185-until-255; video_throttle@185-until-245; ml_attack_alert@205-until-275; stale_badge@210-until-300
- Response defenses after attack: video_throttle@220-until-280; ml_attack_alert@230-until-300; priority_reroute@230-until-300
- Covered required defenses: ml_attack_alert
- Missing required defenses: none
- Missing support defenses: pace_switch
- First required response latency sec: 0
- Response status: required_covered_support_partial
- Audit basis: defense is counted if active at attack time through details.until_sec or emitted within the response window
- Residual risk: Failover chasing is detected by the ML defense window; PACE support may already be active or may expire before a later attack window.
- Safety boundary: closed simulation response audit only; no RF, exploit, or live network action
...
- Required runtime defenses: priority_reroute, stale_badge
- Support defenses: video_throttle
- Active defenses at attack: stale_badge@180-until-270; ml_attack_alert@205-until-275; stale_badge@210-until-300; video_throttle@220-until-280; ml_attack_alert@230-until-300; priority_reroute@230-until-300; ml_attack_alert@255-until-325; priority_reroute@255-until-325; video_throttle@255-until-315
- Response defenses after attack: stale_badge@270-until-360; ml_attack_alert@280-until-350; priority_reroute@280-until-350; video_throttle@290-until-350; stale_badge@300-until-390
- Covered required defenses: priority_reroute, stale_badge
- Missing required defenses: none
- Missing support defenses: none
- First required response latency sec: 0
