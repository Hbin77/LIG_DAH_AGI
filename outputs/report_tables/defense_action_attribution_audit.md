...
| --- | --- | --- | --- | --- | --- | --- | --- |
| priority_reroute | 12 | 0.833333 | priority_inversion_rate | -0.0256654 | 0.424361 | ablation_supported | pass |
...
| pace_switch | 4 | 0.75 | mission_impact | -0.0217057 | -0.0334802 | bounded_tradeoff_supported | pass |
| ml_attack_alert | 8 | 0.75 | mission_impact | -0.00953569 |  | reactive_window_supported | pass |
...
- Mean deltas: impact=-0.0148397, latency=0.141667, trusted_stale=-0.0104167, priority=-0.0256654
...
- Mean deltas: impact=-0.00872196, latency=0.0153846, trusted_stale=0, priority=-0.0253414
...
- Mean deltas: impact=-0.0173957, latency=0.15, trusted_stale=-0.0208333, priority=-0.0183192
- Attribution class: ablation_supported
- Status: pass
...
- Mean deltas: impact=-0.0217057, latency=0.225, trusted_stale=0, priority=-0.0464113
...
- Mean deltas: impact=-0.00953569, latency=-0.5375, trusted_stale=0, priority=-0.020238
