...
| R05 | Decision evidence | pass | trace=215, contract=49, quality=9, runtime=9, loop=8, causality=399, margin=399, goal_alignment=399, feedback=66, memory=9, memory_influence=6, tool=24 | Agent decisions remain explainable by generated evidence, not only by source code. |
| R06 | Closed-loop evidence | pass | battle=51, incident=10, alerts=56, ledger=56, attribution=5, episode=10, coordination_latency=10, stress=6, mission_thread=10, scorecard=10 | The red/blue loop can be reviewed as mission threads, stress scenarios, episodes, coordination latencies, actions, alerts, metric movement, and action-level attribution. |
...
- Observed: trace=215, contract=49, quality=9, runtime=9, loop=8, causality=399, margin=399, goal_alignment=399, feedback=66, memory=9, memory_influence=6, tool=24
- Status: pass
...
- Observed: battle=51, incident=10, alerts=56, ledger=56, attribution=5, episode=10, coordination_latency=10, stress=6, mission_thread=10, scorecard=10
- Status: pass
