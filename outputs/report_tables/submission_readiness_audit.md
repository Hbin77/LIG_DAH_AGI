...
| R05 | Decision evidence | pass | trace=215, contract=49, quality=9, runtime=9, loop=8, causality=399, margin=399, goal_alignment=399, feedback=62, memory=9, memory_influence=6, cross_agent_context=6, tool=33 | Agent decisions remain explainable by generated evidence, not only by source code. |
...
- Observed: trace=215, contract=49, quality=9, runtime=9, loop=8, causality=399, margin=399, goal_alignment=399, feedback=62, memory=9, memory_influence=6, cross_agent_context=6, tool=33
- Status: pass
