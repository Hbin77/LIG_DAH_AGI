...
| R06 | Closed-loop evidence | pass | battle=49, incident=10, alerts=56, ledger=56, attribution=5, episode=10, scorecard=10 | The red/blue loop can be reviewed as episodes, actions, alerts, metric movement, and action-level attribution. |
...
- Evidence: outputs/report_tables/battle_timeline.csv | outputs/report_tables/incident_summary.csv | outputs/report_tables/operator_alerts.csv | outputs/report_tables/defense_effectiveness_ledger.csv | outputs/report_tables/defense_action_attribution_audit.csv | outputs/report_tables/closed_loop_episode_replay.csv | outputs/report_tables/agent_engagement_scorecard.csv | src/experiments/agent_collaboration_graph.py
- Observed: battle=49, incident=10, alerts=56, ledger=56, attribution=5, episode=10, scorecard=10
- Status: pass
- Handoff value: The red/blue loop can be reviewed as episodes, actions, alerts, metric movement, and action-level attribution.
