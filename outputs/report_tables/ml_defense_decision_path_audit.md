...
| MDP03 | Alert cooldown and window refresh | pass | threshold_traces=37; above_threshold_event_traces=18; above_threshold_no_event_refresh_traces=19; ml_attack_alerts=8; min_alert_gap_sec=25; all_alert_probabilities_above_threshold=true | No-op traces above threshold are not dead code; they represent cooldown-bounded window refresh decisions. |
| MDP04 | Core defense fanout | pass | defense_events=31; ml_attack_alert=8; priority_reroute=7; stale_badge=7; video_throttle=6; pace_switch=3 | The ML detector opens the gate; the defense agent still executes mission-aware TSRA-R actions inside that window. |
...
- Evidence: outputs/experiments/E7_ml_aura_ml_tsra_r/tsra_r_decision_traces.jsonl | outputs/experiments/E7_ml_aura_ml_tsra_r/defense_events.jsonl
- Observed: threshold_traces=37; above_threshold_event_traces=18; above_threshold_no_event_refresh_traces=19; ml_attack_alerts=8; min_alert_gap_sec=25; all_alert_probabilities_above_threshold=true
- Status: pass
...
- Observed: defense_events=31; ml_attack_alert=8; priority_reroute=7; stale_badge=7; video_throttle=6; pace_switch=3
- Status: pass
