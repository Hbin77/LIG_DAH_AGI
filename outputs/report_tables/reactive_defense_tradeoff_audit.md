...
| RDT04 | ML alert attack overlap | pass | ml_attack_alerts=8; active_attack_overlap=8; avg_alert_probability=0.942098; threshold=0.75 | Every E7 ML alert overlaps an active simulated attack window, so the alert stream is tied to attack context rather than arbitrary noise. |
| RDT05 | Core defense preservation | pass | e6_core_defense_events=24; e7_core_defense_events=22; core_action_coverage=4/4; e7_actions=ml_attack_alert:8,pace_switch:3,priority_reroute:6,stale_badge:7,video_throttle:6 | E7 may emit fewer core events than always-on E6, but it keeps the core response vocabulary: PACE, priority reroute, stale badge, and video throttle remain present. |
| RDT06 | Bounded impact tradeoff | pass | e6_mission_impact_mean=0.14632; e7_mission_impact_mean=0.159912; e7_minus_e6=0.0135924; e6_std=0.0140585; e7_std=0.0138032 | E7 is not sold as lower-impact than E6. Its observed cost is bounded while remaining stable across repeated seeds. |
| RDT07 | Detector threshold evidence | pass | trace_count=61; probability_count=61; threshold=0.75; below_threshold=24; above_threshold=37; opened_window=38; no_op=41; min_probability=0.229467; max_probability=0.972533 | The ML defender is not always-on: traces include no-op decisions below threshold and defense-window openings above threshold. |
...
- Observed: ml_attack_alerts=8; active_attack_overlap=8; avg_alert_probability=0.942098; threshold=0.75
- Status: pass
...
- Evidence: outputs/experiments/E6_ml_aura_tsra_r/defense_events.jsonl | outputs/experiments/E7_ml_aura_ml_tsra_r/defense_events.jsonl
- Observed: e6_core_defense_events=24; e7_core_defense_events=22; core_action_coverage=4/4; e7_actions=ml_attack_alert:8,pace_switch:3,priority_reroute:6,stale_badge:7,video_throttle:6
- Status: pass
- Interpretation: E7 may emit fewer core events than always-on E6, but it keeps the core response vocabulary: PACE, priority reroute, stale badge, and video throttle remain present.
- Safety boundary: closed simulation reactive-defense tradeoff audit only; no RF, exploit, or live network action
...
- Observed: e6_mission_impact_mean=0.14632; e7_mission_impact_mean=0.159912; e7_minus_e6=0.0135924; e6_std=0.0140585; e7_std=0.0138032
- Status: pass
...
- Observed: trace_count=61; probability_count=61; threshold=0.75; below_threshold=24; above_threshold=37; opened_window=38; no_op=41; min_probability=0.229467; max_probability=0.972533
- Status: pass
