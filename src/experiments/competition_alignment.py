...
ALIGNMENT_SPECS = [
    ...
    AlignmentSpec(
        ...
        implemented_mechanism=(
            ...
            "then emits simulated AttackEvent records; attack decision-path audit verifies candidate "
            "score formulas, toolchain coverage, top-score selection, cadence gates, event payloads, "
            "and tactical/context coverage."
        ),
        ...
        row_checks=[
            RowCountCheck("outputs/report_tables/aura_coa_cards.csv", 10),
    ...
    AlignmentSpec(
        ...
        row_checks=[
            ...
            RowCountCheck("outputs/report_tables/pace_transition_audit.csv", 4),
    ...
    AlignmentSpec(
        ...
        implemented_mechanism=(
            ...
            "candidate rows, emitted event details, and bounded policy score terms; AURA attack path "
    ...
    AlignmentSpec(
        ...
        implemented_mechanism=(
            ...
            "AURA attack decision-path audit checks that selected attack events match top-scored candidates "
            "and persisted AttackEvent payloads before downstream response audits consume them; "
    ...
    AlignmentSpec(
        ...
        content_checks=[
            ...
            ContentCheck("outputs/report_tables/reactive_defense_tradeoff_audit.csv", "active_attack_overlap="),
            ContentCheck("outputs/report_tables/reactive_defense_tradeoff_audit.csv", "e7_minus_e6="),
    ...
    AlignmentSpec(
        ...
        row_checks=[
            ...
            RowCountCheck("outputs/report_tables/metric_gate_summary.csv", 12),
        ],
    ),
    AlignmentSpec(
        alignment_id="A08",
    ...
    AlignmentSpec(
        ...
        implemented_mechanism=(
            ...
            "agent quality gate audit, team handoff audit, hbin quality workflow, submission readiness audit, and process docs define the shared workflow."
        ),
        ...
        row_checks=[
            RowCountCheck("outputs/report_tables/reproduction_order_audit.csv", 18),
            RowCountCheck("outputs/report_tables/agent_quality_gate_audit.csv", 6),
            RowCountCheck("outputs/report_tables/team_handoff_audit.csv", 7),
