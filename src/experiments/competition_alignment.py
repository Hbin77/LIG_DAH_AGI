...
ALIGNMENT_SPECS = [
    ...
    AlignmentSpec(
        ...
        row_checks=[
            ...
            RowCountCheck("outputs/report_tables/agent_tool_usage_audit.csv", 24),
    ...
    AlignmentSpec(
        ...
        content_checks=[
            ...
            ContentCheck("outputs/report_tables/ml_defense_decision_path_audit.csv", "above_threshold_no_event_refresh_traces=21"),
            ...
            ContentCheck("outputs/report_tables/reactive_defense_tradeoff_audit.csv", "e7_minus_e6=0.0141698"),
