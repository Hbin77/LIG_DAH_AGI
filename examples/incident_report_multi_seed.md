...
- TSRA-ML reduced mean mission impact score to `12.926`.
- TSRA-ML mean baseline-adjusted resilience gain was `93.6%`.
- With the same tuned action gate but learned risk fixed to zero, mean mission impact was `15.18` and resilience gain was `90.548%`.
- Learned-model mission-impact contribution versus the zero-model ablation was `2.254` points.
...
- TSRA-ML mean P95 critical latency: `4.26` ticks.
- TSRA-ML mean stale data ratio: `0.0104`.
- TSRA-ML mean priority inversion rate: `0.0`.
- TSRA-ML mean compressed snapshot messages: `43.8`.
- TSRA-ML mean deferred messages: `9.2`.
- TSRA-ML mean backlog messages: `0`.
- TSRA-ML mean expired messages: `0`.
- TSRA-R mean defense intervention ticks: `134.4`.
- TSRA-ML mean defense intervention ticks: `116`.
- TSRA-R mean priority-boost ticks: `118`.
- TSRA-ML mean priority-boost ticks: `97.2`.
- TSRA-ML mean model-influenced ticks: `83.8`.
